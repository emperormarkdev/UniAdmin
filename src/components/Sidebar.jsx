...
const NAV = [
  ...
  { id:"students",      label:"Students",      Icon:GraduationCap,   count:null },
  ...
  return (
    <aside style={{
      ...
      <div style={{ height:60, display:"flex", alignItems:"center", padding:"0 16px", gap:10, borderBottom:"1px solid #f0ede9", flexShrink:0 }}>
        ...
        {!collapsed && (
          <span style={{ fontFamily:"'DM Serif Display',serif", fontSize:17, color:"#1a1a1a", whiteSpace:"nowrap", fontWeight:400 }}>
            UniAdmin
          </span>
        )}
          ...
          >
            ...
            {!collapsed && (
              <>
                ...
                {count && (
                  <span style={{
                    background: page === id ? "rgba(255,255,255,.2)" : "#f0ede9",
                    color: page === id ? "#fff" : "#7a7169",
      ...
      {/* Profile + logout */}
      <div style={{ padding:"10px 10px 14px", borderTop:"1px solid #f0ede9", display:"flex", flexDirection:"column", gap:2 }}>
        <button
        ...
        >
          ...
          <div style={{
            ...
            background: photo ? "transparent" : "#1a1a1a",
            overflow:"hidden", display:"flex", alignItems:"center", justifyContent:"center",
            fontSize:10, fontWeight:700, color:"#fff", flexShrink:0,
            border: page === "profile" ? "2px solid rgba(255,255,255,.3)" : "none",
          }}>
            {photo
          ...
          {!collapsed && (
            <div style={{ minWidth:0, flex:1 }}>
              <p style={{ fontSize:13, fontWeight:600, color: page==="profile" ? "#fff" : "#1a1a1a", whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis" }}>
                {displayName}
              </p>
              <p style={{ fontSize:11, color: page==="profile" ? "rgba(255,255,255,.55)" : "#b0a89e" }}>
                {role}
              </p>
            </div>
          )}
        ...
        <button
          ...
          className="nav-item"
          style={{ color:"#e57373", justifyContent: collapsed ? "center" : "flex-start" }}
